(function(){
	...
	ConfigurationValidator.prototype.mValidationConfigurations = {};
	ConfigurationValidator.prototype.mValidationConfigurations.DEFAULT = {
			context: {
					type : 'string',
					customValidations : [
	...
	ConfigurationValidator.prototype.mValidationConfigurations.PROXY_TUNNEL = {
			host : {
					type : 'string',
					customValidations : [
							function(sKey,sHost,oProxyConfig){
	...
	ConfigurationValidator.prototype.mValidationConfigurations.PROXY = {
			host : {
					type : 'string',
					customValidations : [
							function(sKey,sHost,oProxyConfig){
	...
	ConfigurationValidator.prototype.validateMandatoryProperties = function(mValidationConfig,oProxyConfig){
