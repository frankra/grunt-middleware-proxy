(function(){
    ...
    Utils.prototype._pipeResponseBackToOriginalRes = function(oProxyRes, oOriginalRes,fnNext){
    ...
    Utils.prototype._proxyRequest = function(oConfig,req,res,next){
        ...
        console.log('call to:', oConfig.host,iProxyPort, req.url)
        var mData = {
            hostname: oConfig.host,
            port: iProxyPort,
            path: req.url,
            method: req.method,
            auth : sAuthData,
        ...
        var oProxyRequest = oProxyConnector.request(mData, function (oResponse) {
            console.log('response from:', oConfig.host,iProxyPort, req.url)
            this._pipeResponseBackToOriginalRes(oResponse,res,next);

        }.bind(this));

        this._pipeOriginalRequestBodyToProxyRequest(req,oProxyRequest);
    };

    Utils.prototype._pipeOriginalRequestBodyToProxyRequest = function(req,oProxyRequest){
      var body = [];
